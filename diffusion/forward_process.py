...
class Diffusion:
    def __init__(self, noise_steps=500, schedule='linear', beta_start=1e-4, beta_end=0.02, s=0.008):
        ...
        self.beta = beta.to(config.DEVICE)
        self.alpha = 1 - self.beta
        self.alpha_hat = alpha_hat.to(config.DEVICE)
