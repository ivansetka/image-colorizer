...
class _ConvNormActBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, padding=1, normalize=True):
...
class _UpBlock(nn.Module):
    def __init__(self, in_channels, out_channels, upscale_factor=2, normalize=True):
        ...
        self.block = nn.Sequential(
            _ConvNormActBlock(in_channels, out_channels, normalize=normalize),
...
class _BlendConvBlock(nn.Module):
    def __init__(self, in_channels, in_channels_feature, out_channels, normalize=True):
        ...
        self.fuse = _ConvNormActBlock(in_channels_feature + out_channels, out_channels, normalize=normalize)
